...
def main() -> None:
    ...
    if args.adapter == "neighborhood_assignment":
        ...
        return
    if args.adapter == "venue_classification":
        from apps.jobs.analytics.venue_class import run_venue_classification

        print(_metrics_dict(run_venue_classification()))
        return
...
def run_m3_sequence() -> dict[str, Any]:
    ...
    results["venue_classification"] = _run_safely(run_venue_classification)
