...
BUNDLE_TAXONOMY: tuple[BundleDefinition, ...] = (
    ...
    BundleDefinition(
        slug="pickleball_court_sports",
        label="Pickleball & court sports",
        description="Pickleball, tennis, padel, squash, badminton, and table-tennis courts.",
        category_terms=("racquet_court_sports",),
        keyword_terms=(
            "pickleball",
            "pickle ball",
            "padel",
    ...
    BundleDefinition(
        ...
        description="Indoor and outdoor climbing, bouldering, and adjacent training operators.",
        category_terms=("climbing",),
        keyword_terms=("climbing", "bouldering", "climb", "boulder"),
        tag_terms=("sport=climbing",),
    ),
    BundleDefinition(
        slug="combat_martial_arts",
        label="Combat & martial arts",
        description="Boxing, martial arts, kickboxing, judo, karate, and similar training.",
        category_terms=("combat_sports",),
        keyword_terms=("boxing", "martial arts", "martial_arts", "kickboxing", "judo", "karate"),
        tag_terms=("sport=boxing", "sport=martial arts", "sport=martial_arts"),
    ),
    BundleDefinition(
        slug="public_recreation_courts_fields",
        label="Public recreation courts & fields",
        description="Municipal courts, fields, pitches, tracks, stadiums, and recreation parks.",
        category_terms=("public_recreation", "field_track_sports"),
        keyword_terms=(
            "community centre",
            "community center",
            "recreation centre",
        ...
        tag_terms=(
            ...
            "leisure=track",
            "leisure=stadium",
            "municipal_facility_type=public recreation",
            "facility_type=soccer fields",
            "facility_type=football fields",
            "primary_use=soccer",
            "primary_use=cricket",
    ...
    BundleDefinition(
        ...
        label="Aquatics & ice rinks",
        description="Swimming pools, aquatics centres, ice rinks, skating, hockey, and curling.",
